...
from . import edgetools_flow as op_set_edge_flow


class CHERUB_OT_EdgeLinear(bpy.types.Operator, op_set_edge_flow.SetEdgeLoopBase):
    bl_idname = "mesh.cherub_edge_linear"
    ...
    def invoke(self, context, event):
        op_set_edge_flow.SetEdgeLoopBase.invoke(self, context)
