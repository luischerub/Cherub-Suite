...
import bmesh
from .edgetools import edgetools_util as util
...
class CHERUB_OT_EdgeFlow(bpy.types.Operator, SetEdgeLoopBase):

    bl_idname = "mesh.cherub_edge_flow"
    ...
    def invoke(self, context, event):
        SetEdgeLoopBase.invoke(self, context)
